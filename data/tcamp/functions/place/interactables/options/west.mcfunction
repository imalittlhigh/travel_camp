...
#dye change
summon interaction ~0.8 ~0.3 ~1.15 {NoGravity:1b,width:0.35f,height:0.37f,response:1b,Tags:["tcamp.interaction.tent.options.dye","tcamp.interaction.tent.options","tcamp.interaction.tent","tcamp.interaction","tcamp"]}
#dismantling tent
##has direction tag
