...
#effects
execute positioned ~0.5 ~0.4 ~1 run function tcamp:cardinal/effects/sound/general_positive_block
execute positioned ~0.5 ~0.4 ~1 run function tcamp:cardinal/effects/tent/visual/spawn_confirmation
