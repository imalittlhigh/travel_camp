...
summon marker ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Tags:["tcamp","tcamp.marker","tcamp.marker.copy_campinfo"]}
#copies item tags
data modify entity @e[tag=tcamp.marker.copy_campinfo,limit=1,sort=nearest] data.camp set from entity @e[tag=tcamp.cart.copy_campinfo,limit=1,sort=nearest] Items[0].tag.camp
#copies item name
data modify entity @e[tag=tcamp.marker.copy_campinfo,limit=1,sort=nearest] data.name set from entity @e[tag=tcamp.cart.copy_campinfo,limit=1,sort=nearest] Items[0].tag.display.Name
data modify entity @e[tag=tcamp.marker.copy_campinfo,limit=1,sort=nearest] data.color set from entity @e[tag=tcamp.cart.copy_campinfo,limit=1,sort=nearest] Items[0].tag.display.color
