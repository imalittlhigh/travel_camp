...
#setting structure
setblock ~ ~ ~ structure_block[mode=load]{name:"tcamp:tent/medium/tent_medium_south",posX:-3,posY:0,posZ:-3,rotation:"NONE",mirror:"NONE",mode:"LOAD",ignoreEntities:1b} replace
...
execute align xyz positioned ~1 ~1 ~ run function tcamp:interactables/spawn/options/south
...
#tent direction
execute align xyz positioned ~0.5 ~ ~0.5 run tag @e[tag=tcamp.marker.campinfo,limit=1,sort=nearest,distance=..1] add tcamp.marker.campinfo.south

#set colour function
function tcamp:tent/modify/blocks/colour/size/medium/south

#spawn bedroll
execute positioned ~1.5 ~ ~1.5 run function pbroll_camp:place/roll/north
