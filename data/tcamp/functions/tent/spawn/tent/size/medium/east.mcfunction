...
#setting structure
setblock ~ ~ ~ structure_block[mode=load]{name:"tcamp:tent/medium/tent_medium_east",posX:-3,posY:0,posZ:-3,rotation:"NONE",mirror:"NONE",mode:"LOAD",ignoreEntities:1b} replace
...
execute align xyz positioned ~ ~1 ~-1 run function tcamp:interactables/spawn/options/east
...
#set colour function
function tcamp:tent/modify/blocks/colour/size/medium/east

#spawn bedroll
execute positioned ~1.5 ~ ~-0.5 run function pbroll_camp:place/roll/west
