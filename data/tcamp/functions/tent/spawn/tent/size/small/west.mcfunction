...
#set colour function
execute align xyz positioned ~0.5 ~ ~0.5 if data entity @e[tag=tcamp.marker.campinfo,limit=1,sort=nearest,distance=..1] data.camp{colour:"minecraft:red_dye"} run function tcamp:tent/modify/blocks/colour/size/small/west
