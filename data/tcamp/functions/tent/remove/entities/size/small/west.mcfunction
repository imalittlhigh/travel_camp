...
#remove bedroll
execute positioned ~0.5 ~ ~0.5 run function pbroll_camp:remove/roll/east
...
execute align xyz positioned ~ ~1 ~ run function tcamp:interactables/remove/options/west
