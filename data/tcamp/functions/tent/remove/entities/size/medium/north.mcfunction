...
execute align xyz positioned ~-1 ~1 ~ run function tcamp:interactables/remove/confirmation/north
execute align xyz positioned ~-1 ~1 ~ run function tcamp:interactables/remove/options/north
