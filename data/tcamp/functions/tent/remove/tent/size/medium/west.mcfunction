...
execute if predicate tcamp:intact/tents/medium/west run tag @s add tcamp.marker.campinfo.intact
...
#remove entities
execute as @s[tag=tcamp.marker.campinfo.intact] run function tcamp:tent/remove/entities/size/medium/west