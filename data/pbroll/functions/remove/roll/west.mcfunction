...
execute as @s[tag=pbroll.interaction.bedroll.west.head] at @s positioned ~-1 ~ ~ run kill @e[tag=pbroll.interaction.bedroll.west.feet,distance=..0.1,limit=1,sort=nearest]
execute as @s[tag=pbroll.interaction.bedroll.west.head] at @s positioned ~-0.5 ~ ~-0.5 run kill @e[tag=pbroll.block_display.bedroll,distance=..0.1,limit=6,sort=nearest]


#if interacted with feet
execute as @s[tag=pbroll.interaction.bedroll.west.feet] at @s positioned ~1 ~ ~ run kill @e[tag=pbroll.interaction.bedroll.west.head,distance=..0.1,limit=1,sort=nearest]
execute as @s[tag=pbroll.interaction.bedroll.west.feet] at @s positioned ~0.5 ~ ~-0.5 run kill @e[tag=pbroll.block_display.bedroll,distance=..0.1,limit=6,sort=nearest]
