...
execute as @s[tag=pbroll.interaction.bedroll.east.head] at @s positioned ~1 ~ ~ run kill @e[tag=pbroll.interaction.bedroll.east.feet,distance=..0.1,limit=1,sort=nearest]
execute as @s[tag=pbroll.interaction.bedroll.east.head] at @s positioned ~-0.5 ~ ~-0.5 run kill @e[tag=pbroll.block_display.bedroll,distance=..0.1,limit=6,sort=nearest]


#if interacted with feet
execute as @s[tag=pbroll.interaction.bedroll.east.feet] at @s positioned ~-1 ~ ~ run kill @e[tag=pbroll.interaction.bedroll.east.head,distance=..0.1,limit=1,sort=nearest]
execute as @s[tag=pbroll.interaction.bedroll.east.feet] at @s positioned ~-1.5 ~ ~-0.5 run kill @e[tag=pbroll.block_display.bedroll,distance=..0.1,limit=6,sort=nearest]
